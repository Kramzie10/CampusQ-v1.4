...
namespace CampusQ.MVP.Data
{
    ...
    {
        public static string ConnectionString { get; set; } = "Data Source=DESKTOP-8DB7NJ9\\SQLEXPRESS;Initial Catalog=CampusQ;Integrated Security=True;TrustServerCertificate=True";
